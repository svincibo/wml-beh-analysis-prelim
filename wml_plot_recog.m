...
remove = [32];
testortestgen = 'test_gen'; %'test' or 'test_gen'

% Create date-specific file name that indicates how many subjects.
datestring = '20210430';
filename = sprintf('wml_beh_data_%s_%s', testortestgen, datestring);

% Load data.
load(fullfile(rootDir, 'wml-data', 'wml-data-beh-prelim-Spring2021', 'supportFiles', filename), 'data_recog');
...
ylimlo = 0.25; ylimhi = 1;

% Get individual subject means for each day.
subjectlist = unique(data_recog.subID(find(data_recog.subID ~= remove)));
...
% if strcmp(save_figures, 'yes')
    ...
    print(fullfile(rootDir, 'wml-data', 'wml-data-beh-prelim-Spring2021', 'plots', ['plot_recog_' testortestgen '_rt']), '-dpng')
    print(fullfile(rootDir, 'wml-data', 'wml-data-beh-prelim-Spring2021', 'plots', 'eps', ['plot_recog_' testortestgen '_rt']), '-depsc')
...
% if strcmp(save_figures, 'yes')
    ...
    print(fullfile(rootDir, 'wml-data', 'wml-data-beh-prelim-Spring2021', 'plots', ['plot_recog_' testortestgen '_acc']), '-dpng')
    print(fullfile(rootDir, 'wml-data', 'wml-data-beh-prelim-Spring2021', 'plots', 'eps', ['plot_recog_' testortestgen '_acc']), '-depsc')
