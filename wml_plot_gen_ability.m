...
% if strcmp(save_figures, 'yes')
    ...
    print(fullfile(rootDir, 'wml-data', 'wml-data-beh-prelim-Spring2021', 'plots', 'plot_recog_genability_rt'), '-dpng')
    print(fullfile(rootDir, 'wml-data', 'wml-data-beh-prelim-Spring2021', 'plots', 'eps', 'plot_recog_genability_rt'), '-depsc')
...
% if strcmp(save_figures, 'yes')
    ...
    print(fullfile(rootDir, 'wml-data', 'wml-data-beh-prelim-Spring2021', 'plots', 'plot_recog_genability_acc'), '-dpng')
    print(fullfile(rootDir, 'wml-data', 'wml-data-beh-prelim-Spring2021', 'plots', 'eps', 'plot_recog_genability_acc'), '-depsc')
